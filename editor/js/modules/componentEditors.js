...
LS.FXStack.prototype.inspect = function (inspector, component) {
    ...
    title.addEventListener("contextmenu", function (e) {
        ...
        var contextmenu = new LiteGUI.ContextMenu(["Copy", "Paste"], {
...
LS.Components.MorphDeformer["@inspector"] = function (component, inspector) {
    inspector.addCombo("mode", component.mode, {
        values: LS.Components.MorphDeformer["@mode"].values, callback: function (value) {
...
//======================================================================================
// "Particle Emissor" component inspector
//======================================================================================
...
//======================================================================================
// "CameraController" component.. called before showing it's inspector
//======================================================================================
...
LS.Components.Skybox["@inspector"] = function (component, inspector) {
...
LS.Components.VideoWindow["@inspector"] = function (component, inspector) {
    ...
    inspector.addCombo("Aspect Ratio", component.aspect_ratio, {
        ...
        values: {
            "1:1": LS.Components.VideoWindow.Aspect11,
            "4:3": LS.Components.VideoWindow.Aspect43,
            "16:9": LS.Components.VideoWindow.Aspect169,
            "16:10": LS.Components.VideoWindow.Aspect1610,
            "Customized": LS.Components.VideoWindow.AspectCustomized,
        },
        callback: function (v) {
    ...
    if (component.aspect_ratio == LS.Components.VideoWindow.AspectCustomized) {
    ...
    inspector.addCombo("Loop Mode", component.loop_mode, {
        ...
        values:
        {
            "Loop": LS.Components.VideoWindow.LOOP,
            "Once": LS.Components.VideoWindow.ONCE
        },
        callback: function (v) {
...
LS.Components.PlayAnimation["@inspector"] = function (component, inspector) {
    
    inspector.addCombo("Loop Mode", component.mode, {
        pretitle: AnimationModule.getKeyframeCode(component, "mode"),
        values: LS.Components.PlayAnimation.MODES,
        callback: function (v) {
            component.mode = v;
            inspector.refresh();
        }
...
LS.Components.MeshRenderer["@inspector"] = function (component, inspector) {
...
LS.Components.SkinDeformer["@inspector"] = function (component, inspector) {
...
LS.Components.Marker2D["@inspector"] = function (component, inspector) {
